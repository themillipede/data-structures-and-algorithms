...
# Input: A string S consisting of latin letters, digits, punctuation marks and brackets from the set []{}().
# Constraints: The length of S is at least 1 and at most 10^5.
# Output: The 1-based index of the first unmatched closing bracket if one exists, otherwise the 1-based index of the
#     first unmatched opening bracket if one exists, otherwise "Success" if S uses brackets correctly.
